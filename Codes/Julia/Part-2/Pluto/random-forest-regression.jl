...
# ╔═╡ d766de3d-bdb1-454a-bafd-5bac0f2b4688
using CSV, DataFrames

# ╔═╡ 906a640f-4a68-4142-8655-91d087534365
using MLJ

# ╔═╡ 44daff90-2db8-4a5a-9378-1c52bd3c3635
md"# RANDOM FOREST REGRESSION"

# ╔═╡ 8aa32ed2-a4d6-4e82-8abd-0ad2d0aae40f
md"
```julia
...
# ╔═╡ b6d9d095-5c65-4488-8fc0-0c1bfe4e9b8b
md"Import librairies"

# ╔═╡ 12ba5584-48cf-43c6-b4da-91b81268e9f0
md"Load data from CSV file"

# ╔═╡ 1f07f150-5226-4b53-98d1-abf7d9279e15
df = CSV.read("../../Datasets/50_Startups.csv", DataFrame)

# ╔═╡ 0f3314ad-f760-4355-807e-a57c75027485
schema(df)

# ╔═╡ c5111bfc-137d-47cb-b835-5e954d835a88
md"Design the features"

# ╔═╡ b27f656c-054c-437b-8248-b3568c11edaf
colnames = ["rd", "admin", "spend", "state"]

# ╔═╡ 04b91509-189a-4b1f-a99e-704ad549b7b2
md"Encoding the state column"

# ╔═╡ 97c3a4ef-b2dd-4a17-9136-137d6ac077b1
ce = ContinuousEncoder()

# ╔═╡ 8531e94b-90bc-4190-805b-57fd4566fe35
rename!(X, Symbol.(colnames))

# ╔═╡ 9d833a1e-8790-4e22-b231-5d6274f0c390
coerce!(X, :state => Multiclass)

# ╔═╡ a1c8cd08-d33f-4d9e-8e69-c3ccc04d3b69
md"Extract target vector"

# ╔═╡ 01e865a5-7bf3-4126-82f0-10022a7f0053
y = df.Profit

# ╔═╡ 9e1f3c46-fa17-420f-b1ee-c7e26ca906b6
md"Preparing for the split"

# ╔═╡ 434c56c1-e570-430a-88cd-93a5b47f4c98
train, test = partition(eachindex(y), 0.8, shuffle=true, rng=123)

# ╔═╡ 9f0e2087-b5f3-4bfb-a433-a55dca4aa94d
Xtrain, Xtest = X[train, :], X[test, :]

# ╔═╡ 0fdd1044-8a6a-4b13-9b3e-91c162ed4585
ytrain, ytest = y[train], y[test]

# ╔═╡ ea095e1e-a4d3-4e9d-b92c-a69ddd1157d5
md"Load & instantiate the random forest regressor model"

# ╔═╡ 2da8687d-096a-4fe5-9806-8d72393bf914
RFR = @load RandomForestRegressor pkg=DecisionTree

# ╔═╡ 7c9b6455-8044-4409-a0a8-2462ca6837f0
rfr_ = RFR(max_depth=5, min_samples_split=3)

# ╔═╡ 57a24d3d-d943-4bbf-a08a-69e26963527a
...
# ╔═╡ 28d5723e-30e7-48ac-a9bb-0ed6c5481b19
md"Train & fit"

# ╔═╡ 3d83d266-88c2-4873-abc8-6384ac1e9c41
rfr = machine(rfr_, Xtrain, ytrain) |> fit!

# ╔═╡ 7c3e144f-cde5-4393-bb26-2dfed6d80c80
println("Params of fitted model are $(fitted_params(rfr).forest)")

# ╔═╡ f87f5c43-54cf-4347-a234-b26242e49417
md"Prediction"

# ╔═╡ 256574f2-0038-433f-8271-11388fb486cb
yhat_rfr = predict(rfr, Xtest)

# ╔═╡ 2c573ab5-ddd9-45ba-95e7-50dfa2114bb1
md"Results & metrics"

# ╔═╡ b8a60db1-cbdb-4c56-a658-545ce29fec65
println("Error is $(sum((yhat_rfr .- ytest).^2) ./ length(ytest))")

# ╔═╡ 8e43df32-3c3c-4bfc-bccf-9b214c2ae13d
X = df[!, 1:4]

# ╔═╡ f68f1a51-c863-44ae-adf9-ef810a291464
...
manifest_format = "2.0"
project_hash = "876ee674ee0be5d856baa3919e70b38fd8f3eafe"
